...
class TeamFrostTests(unittest.TestCase):
    def test_find_us_phone_number(self):
        ...
        results_list = find_email("123-456-7890 is my phone number.")
        self.assertEqual(results_list[0], '123-456-7890')
        # tests 2 emails
        results_list = find_email("123-456-7890 is my phone number, and 703-356-7643 is Jordan's.")
        self.assertEqual(results_list[0], '123-456-7890')
        self.assertEqual(results_list[1], '703-356-7643')
        # tests invalid email
        results_list = find_email("My phone number is 1234567890")
