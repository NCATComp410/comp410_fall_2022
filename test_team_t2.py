...
results_list = find_email('jim.jones@jones.com is my email address')
self.assertEqual(results_list[0], 'jim.jones@jones.com')
self.assertEqual(results_list[1], 'jones.jim@jim.com')

#return results for wrong formatting 
results_list = find_email('My email address is jimmy.jones@jones.com')
self.assertFalse(results_list)

#return results with unneccessary characters
results_list = find_email('My email address is jimm/;.jones@jones.com')
self.assertFalse(results_list)
