...
def anonymize_pii(text) :
    ...
    patterns = {
        ...
        "MASTERCARD": Pattern(name='MASTERCARD_pattern',
    ...
    recognizers = {
        ...
        "MASTERCARD": PatternRecognizer(supported_entity='MASTERCARD', patterns=[patterns['MASTERCARD']]),
    }
    ...
    detect_types = ['US_SSN', 'AMEX', 'IG_HANDLE', 'MASTERCARD']
